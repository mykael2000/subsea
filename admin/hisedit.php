...
$depoid = $_GET['id'];
$sqleu = "SELECT * FROM history WHERE id='$depoid'";
...
if(isset($_POST['submit'])){
    ...
    $sqlup = "UPDATE history set status ='$status', amount='$amount', coin='$coin' WHERE id='$depoid'";
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="coin" class="form-control" id="exampleInputeth"
                                    placeholder="Enter amount" value="<?php echo $usereu['coin']; ?>">
                            </div>
                            <div class="form-group">
