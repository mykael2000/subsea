...
$depoid = $_GET['id'];
$sqleu = "SELECT * FROM crypto_withdrawal WHERE id='$depoid'";
...
<body style="background-color: #1e2024; padding: 45px;">
    ...
    <div style="color: #ffff;"><hr/>
        <h3>Dear user</h3>
        <p>Your withdrawal request has been cancelled due to some reasons</p>
                ...
                <div class="box box-primary">
                    ...
                    <form action="" method="post" role="form">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="exampleInputsdt">Address</label>
                                <input type="text" name="usdt_balance" class="form-control" id="exampleInputusdt"
                                    placeholder="Enter amount" value="<?php echo $usereu['address']; ?>" readonly>
                            </div>
                            <div class="form-group">
