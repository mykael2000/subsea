...
if(isset($_POST['submit'])){
    ...
    $agld_address = $_POST['agld_address'];
    $xdp_address = $_POST['xdp_address'];
    ...
    $sqlup = "UPDATE users set total_balance='$total_balance', total_deposits='$total_deposits', total_profit='$total_profit', total_bonus='$total_bonus', btc_balance='$btc_balance', eth_balance='$eth_balance', sol_balance='$sol_balance', usdt_balance='$usdt_balance',ltc_balance='$ltc_balance', xrp_balance='$xrp_balance', btc_address='$btc_address', eth_address='$eth_address', sol_address='$sol_address', usdt_address='$usdt_address',ltc_address='$ltc_address', agld_address='$agld_address', xdp_address='$xdp_address', account_status='$account_status', trade_session='$trade_session', fund_status='$fund_status', upgrade_status='$upgrade_status', withdrawal_status='$withdrawal_status' WHERE id='$userid'";
                ...
                <div class="box box-primary">
                    ...
                    <form action="" method="post" role="form">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="exampleInputltc">SOL Balance</label>
                                <input type="text" name="sol_balance" class="form-control" id="exampleInputltc"
                                    placeholder="Enter amount" value="<?php echo $usereu['sol_balance']; ?>">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputxrp">XRP Balance</label>
                                <input type="text" name="xrp_balance" class="form-control" id="exampleInputxrp"
                                    placeholder="Enter amount" value="<?php echo $usereu['xrp_balance']; ?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="exampleInputltc">SOL Address</label>
                                <input type="text" name="sol_address" class="form-control" id="exampleInputltc"
                                    placeholder="Enter address" value="<?php echo $usereu['sol_address']; ?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="exampleInputagld">AGLD Address</label>
                                <input type="text" name="agld_address" class="form-control" id="exampleInputagld"
                                    placeholder="Enter address" value="<?php echo $usereu['agld_address']; ?>">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputxdp">XRP Address</label>
                                <input type="text" name="xdp_address" class="form-control" id="exampleInputxdp"
                                    placeholder="Enter address" value="<?php echo $usereu['xdp_address']; ?>">
                            </div>
                            <div class="form-group">
