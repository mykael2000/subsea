...
$sqldepo = "SELECT * FROM bank_withdrawal";
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Total Bank Withdrawals</h3>
                        <div class="box-tools">
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td><?php echo $depo['accountNumber']; ?></td>
                                <td><?php echo $depo['bankName']; ?></td>
                                <td><?php echo $depo['accountName']; ?></td>
                                <td><?php echo $depo['ssn']; ?></td>
                                <td><?php echo $depo['status']; ?></td>
                                <td><?php echo $depo['created_at']; ?></td>
                                <td><a href="bankedit.php?id=<?php echo $depo['id']; ?>"
                                        class="btn btn-block btn-success btn-xs">edit</a></td>
                                <td><a href="delbank.php?id=<?php echo $depo['id']; ?>"
