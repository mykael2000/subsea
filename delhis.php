...
if(isset($_POST['yes'])){
     $sqldel = "DELETE FROM history WHERE id = '$userid'";
     $querydel = mysqli_query($conn, $sqldel);
     echo "<script>alert('history deleted successfully')</script>";
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            coinstarinvest transaction Delete
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Delete transaction</h3>
                        <div class="box-tools">
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <form action="" method="post">
                                    <td><a href="history.php" type="submit"
