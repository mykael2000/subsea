...
if(isset($_POST['profit'])){
    ...
    $newPro = $getter['total_profit'] + $amount;
    $type = "profit";
    $address = "";
    $prosql = "UPDATE users set total_balance = '$newBal', total_profit = '$newPro' WHERE id = '$account'";
    ...
    $message = '<div class="alert alert-success d-flex align-items-center" role="alert">
            ...
            <div>Profit of '.$amount.' added to '.$useremail.' successfully</div>
        </div>';
        try {
    //Server settings
    ...
    $mail->Subject = 'Profit added';
    $mail->Body    = '<html><head></head></head>
<body style="background-color: #1e2024; padding: 45px;">
    <div>
        <img style="position:relative; left:35%;" src="https://coinstarinvestment.com/assets/logo/logo.png">
        <h3 style="color: black;">Mail From support@coinstarinvestment.com - Profit Added</h3>
    </div>
    <div style="color: #ffff;"><hr/>
        <h3>Dear '.$firstname.'</h3>
        <p>Profit of '.$amount.' has successfully been credited to your account, kindly sign in to view your balance</p>
       
        <a style="background-color:#060c39;color:#ffff; padding:15px; text-decoration:none;border-radius: 10px;font-size: 20px;" href="https://coinstarinvestment.com/dash/dashboard/auth/signin.php" class="btn btn primary">Sign in</a>
            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Add Profit To a User</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label style="padding-right: 5px;" for="exampleInputltc">Select an
                                    ...
                                    class="badge rounded-pill"></button>
